...
# ============================================================================
# 安全围栏配置 (Guardrails Configuration)
# ============================================================================

# 是否启用安全测试围栏
GUARDRAILS_ENABLED = os.getenv("GUARDRAILS_ENABLED", "true").lower() == "true"
GUARDRAILS_MAX_SENSITIVE_RECORDS = int(os.getenv("GUARDRAILS_MAX_SENSITIVE_RECORDS", "5"))
GUARDRAILS_BLOCK_DANGEROUS_SQL = os.getenv("GUARDRAILS_BLOCK_DANGEROUS_SQL", "true").lower() == "true"
GUARDRAILS_BLOCK_DOS = os.getenv("GUARDRAILS_BLOCK_DOS", "true").lower() == "true"
GUARDRAILS_BLOCK_FILE_DESTRUCTION = os.getenv("GUARDRAILS_BLOCK_FILE_DESTRUCTION", "true").lower() == "true"

# ============================================================================
# 漏洞报告配置 (Vulnerability Report Configuration)
# ============================================================================

VULN_REPORT_FORMAT = os.getenv("VULN_REPORT_FORMAT", "markdown").lower()
VULN_REPORT_ENABLED = os.getenv("VULN_REPORT_ENABLED", "true").lower() == "true"

# ============================================================================
# 钉钉推送配置 (DingTalk Notification Configuration)
# ============================================================================
...
DINGTALK_WEBHOOK = os.getenv(
    "DINGTALK_WEBHOOK",
    "https://oapi.dingtalk.com/robot/send?access_token=d08bc9edbb0d238886788994008af1ca8299a244cfa28621f067049341d9ce10",
)

# 钉钉机器人加签 Secret
DINGTALK_SECRET = os.getenv(
    "DINGTALK_SECRET",
    "SEC6664fb5b39ddd4c93620578e6716a090ca6486af705eeef53d0f1e694553c4ea",
)

# 发现漏洞后是否自动停止测试
DINGTALK_STOP_ON_VULN = os.getenv("DINGTALK_STOP_ON_VULN", "true").lower() == "true"
