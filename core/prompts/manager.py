...
from conf.config import SCENARIO_MODE, PROMPT_LANGUAGE, EXECUTOR_MAX_STEPS, GUARDRAILS_ENABLED
        ...
        try:
            ...
            if GUARDRAILS_ENABLED:
                ...
                if guardrails.enabled:
                    guardrails_summary = guardrails.get_redlines_summary()
        except Exception:
            guardrails_summary = ""
        input_variables["guardrails_summary"] = guardrails_summary
